...
public class SqlDBServiceImpl extends BaseBluemixService<SqlDBConfiguration> implements SqlDBService {

	public SqlDBServiceImpl() {
		super(SqlDBConfiguration.class);
	}
